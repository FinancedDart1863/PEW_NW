...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition C400mmTurret => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "C400mmTurret",
            ...
            HardPoint = new HardPointDef 
            {
                ...
                Loading = new LoadingDef {
                    ...
                    SkipBarrels = 0,
                    ReloadTime = 1860, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
            ...
            Ammos = new [] {
                C400mmAmmoAP, C400mmShrapnel, C400mmAmmoHE, C400mmAPHEShrapbase, C400CSecond, C400mmHEShrapbase,               

            },
            Animations = C400Turret_Animation,
