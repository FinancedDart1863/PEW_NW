...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition C30mmRevolver => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "C30mmRevolver",
            ...
            {
                PartName = "30mm AutoCannon", // name of weapon in terminal
            ...
            Ammos = new [] {
               C30mmAmmo, C30mmAmmoAP, C30mmAmmoHE, C30mmAmmoAT, C30mmAmmoDU, C30mmAmmoR,
