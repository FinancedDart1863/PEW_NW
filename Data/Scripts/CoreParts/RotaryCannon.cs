...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition RotaryCannon => new WeaponDefinition {
            ...
            {
                PartName = "30mm Rotary Cannon", // name of weapon in terminal
                ...
                Loading = new LoadingDef {
                    ...
                    Cooldown = .60f, //percent of max heat to be under to start firing again after overheat accepts .2-.95
            ...
            Ammos = new [] {
                C30mmAmmo, C30mmAmmoAP, C30mmAmmoHE, C30mmAmmoR,
